...
```
```
[user@rocky9 lab-12]$ yc managed-kubernetes cluster list --folder-name labfolder
+----------------------+---------+---------------------+---------+---------+-----------------------+-------------------+
|          ID          |  NAME   |     CREATED AT      | HEALTH  | STATUS  |   EXTERNAL ENDPOINT   | INTERNAL ENDPOINT |
+----------------------+---------+---------------------+---------+---------+-----------------------+-------------------+
| cata9c3gm1g3hcdth09e | k8s-lab | 2024-01-10 07:18:17 | HEALTHY | RUNNING | https://158.160.19.24 | https://10.1.0.33 |
+----------------------+---------+---------------------+---------+---------+-----------------------+-------------------+
```
...
```
[user@rocky9 lab-12]$ yc vpc security-group get --name k8s-public-services --folder-name labfolder
id: enp84ucdpovu1gv9chnq
folder_id: b1gul3kict74o0jbd6t9
created_at: "2024-01-10T07:18:16Z"
